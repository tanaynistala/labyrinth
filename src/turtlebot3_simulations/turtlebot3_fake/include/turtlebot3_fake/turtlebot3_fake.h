...
#define MAX_LINEAR_VELOCITY             0.10   // 0.22 m/s
#define MAX_ANGULAR_VELOCITY            0.5    // 2.84 rad/s
...
class Turtlebot3Fake
{
 ...
 private:
  ...
  ros::Publisher joint_states_pub_;std::string robot_model = nh_.param<std::string>("tb3_model", "");
